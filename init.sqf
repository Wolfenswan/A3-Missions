...
f_var_mapClickTeleport_Units = ["UnitNATO_JSL_SL","UnitNATO_J1_FTL","UnitNATO_J2_FTL","UnitNATO_J3_FTL"];				// Restrict map click teleport to these units
f_var_mapClickTeleport_Height = 800;				// If > 0 map click teleport will act as a HALO drop and automatically assign parachutes to units
