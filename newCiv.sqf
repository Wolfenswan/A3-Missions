...
//Add death handler
_unit addEventHandler ["Killed","alivePlayerList = alivePlayerList - [_this select 0];"];
...
if (local _unit) then {
	...
	//ws_headgears = _headgears + ["rds_Profiteer_cap4","rds_Profiteer_cap1","rds_Profiteer_cap2","rds_Profiteer_cap3","rds_Villager_cap1","rds_Villager_cap2","rds_worker_cap1","rds_worker_cap2","rds_worker_cap3","rds_worker_cap4"];
