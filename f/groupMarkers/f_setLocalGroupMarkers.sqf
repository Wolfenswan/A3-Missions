...
// Markers seen by players in CSAT slots.
	...
	case "opf_f":
	{
		...
		["GrpCSAT_R",  4, "R", "ColorOrange"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in AAF slots.
	...
	case "ind_f":
	{
		...
		["GrpAAF_R", 4, "R", "ColorRed"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_J1", 1, "J1", "ColorGreen"] spawn f_fnc_localGroupMarker;
		["GrpAAF_J2", 1, "J2", "ColorGreen"] spawn f_fnc_localGroupMarker;
		...
		["GrpAAF_ENG1",  6, "ENG1", "ColorOrange"] spawn f_fnc_localGroupMarker;
 		...
 		["GrpAAF_IFV1",  7, "MRAP1", "ColorRed"] spawn f_fnc_localGroupMarker;
...
// Markers seen by players in BLUFOR-FIA slots.
	...
	case "blu_g_f":
	{
		...
		["GrpFIA_A2", 1, "DTL2", "ColorBlue"] spawn f_fnc_localGroupMarker;
		...
		["GrpFIA_TECH1",  7, "TECH1", "ColorOrange"] spawn f_fnc_localGroupMarker;
		["GrpFIA_TECH2",  7, "TECH2", "ColorOrange"] spawn f_fnc_localGroupMarker;
