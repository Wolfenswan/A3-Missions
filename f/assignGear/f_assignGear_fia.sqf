...
// Sniper
_SNrifle = "arifle_MXM_Black_F";
_SNrifleMag = "30Rnd_65x39_caseless_mag";
...
_baseHelmet = ["H_Cap_khaki_specops_UK","H_HelmetB_light_snakeskin","H_HelmetSpecB","H_HelmetSpecB_paint1","H_HelmetSpecB_paint2","H_HelmetSpecB_blk"];
