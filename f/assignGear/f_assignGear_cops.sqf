// F3 - Folk ARPS Assign Gear Script - COPS
...
_carbine = _smg; // Slight randomization, biased towards TRG
_carbinemag = _smgmag;
_carbinemag_tr = _smgmag;
...
// Backpacks
_bag = "B_AssaultPack_blk";			// carries 160, weighs 20
...
_baseHelmet = ["H_Beret_blk_POLICE","H_Cap_police","H_Beret_gen_F","H_MilCap_gen_F"];
_baseGlasses = ["G_Aviator"]; //"G_Bandanna_blk"

// Vests
_lightRig = ["V_Chestrig_blk"];
_standardRig = ["V_TacVest_blk_POLICE","V_TacVest_gen_F"];
