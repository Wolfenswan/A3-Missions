...
DESTROYING CACHES
<br/>
Satchel charges must be used to destroy caches. All units carry a satchel each.
<br/><br/>
TRANSPORT
<br/>
...
<br/>
Destroy the marked Syndikat equipment caches by using satchels, with minimum casualties to your squad.<br/><br/>
HALO<br/>
...
OBJECTIVES<br/>
Destroy Syndikat weapon caches. Mission is successful once either %1 out of %2 caches are destroyed, or all Syndikat units have been eliminated.<br/>
...
<br/>
We are supporting AAF in counter-insurgency operations around Altis. Intel has indicated locations of several Syndikat guerrilla equipment caches.
However Syndikat is about to relocate the caches, and we must move in swiftly to intercept them and destroy them.
<br/><br/>
<font size='18'>ENEMY FORCES</font>
<br/>
Syndikat guerrillas, number unknown. No armed vehicles or armor. The caches are very likely to be guarded. The enemy can communicate your location amongst themselves if you are spotted.
"]];
