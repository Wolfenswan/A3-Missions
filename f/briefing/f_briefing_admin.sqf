...
_briefing = _briefing + "
ACTIVE CURATOR<br/>
By clicking <execute expression=""[[player,true,false],'f_fnc_zeusInit',false] spawn BIS_fnc_MP;"">here</execute> you will be able to activate the curator (or 'ZEUS') mode with all powers enabled and control over all units.<br/><br/>
";
