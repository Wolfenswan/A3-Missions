...
_rifle_attach = ["acc_pointer_IR",nil];
...
_carbine_attach = ["acc_pointer_IR",nil];
...
_glrifle_attach = ["acc_pointer_IR",nil];
...
_baseHelmet = ["H_Cap_brn_SPECOPS","H_Cap_tan_specops_US"];
...
// LOADOUT: DEPUTY COMMANDER AND SQUAD LEADER
	case "dc":
	{
		...
		_unit addmagazines [_glflarered,4];
